    ...
    return (
        <div className="flex items-center justify-between w-full font-sans">
            <span className="flex items-center gap-x-8">
                ...
                <h1 className="text-3xl font-bold text-yellow-200/70">ELEGANT GALLERY</h1>
            </span>
            ...
            {showDialog && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="w-full max-w-md p-6 text-gray-900 bg-white shadow-xl rounded-2xl">
                        ...
                        <p className="mb-2">
                            You have     <button onClick={decrese} className="p-1 py-0 bg-yellow-400">-</button> <strong

                            >{num}</strong>  <button onClick={increse} className="p-1 py-0 bg-yellow-400">+</button>  item(s) in your cart.
                        </p>
                        <p></p>
